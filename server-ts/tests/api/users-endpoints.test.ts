...
import { POST as terminateUser } from '../../app/api/users/[id]/terminate/route';
...
describe('Users API endpoints', () => {
  ...
  it('POST /api/users creates user and sets roles', async () => {
    queryMock
  ...
  it('GET /api/users/:id blocks access for another non-admin user', async () => {
  ...
  it('DELETE /api/users/:id allows hard delete for admin', async () => {
  ...
  it('POST /api/users/:id/terminate closes and obfuscates account', async () => {
    queryMock
  ...
  it('POST /api/users/login blocks inactive user', async () => {
