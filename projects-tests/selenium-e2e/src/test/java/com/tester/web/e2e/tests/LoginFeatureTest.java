...
class LoginFeatureTest extends AbstractUiTest {
  ...
  @DisplayName("AUTH-01 login with next=/cart should redirect to cart with greeting")
  ...
  @Test
  @Severity(SeverityLevel.NORMAL)
  @DisplayName("AUTH-02 authenticated session should persist after page reload")
  ...
  @DisplayName("AUTH-03 blank email with filled password should show required fields validation")
  ...
  @Test
  @Severity(SeverityLevel.MINOR)
  @DisplayName("LOGIN-06 email and password fields should cap input at 30 characters")
