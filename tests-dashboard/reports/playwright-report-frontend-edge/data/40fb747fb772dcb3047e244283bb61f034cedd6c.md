...
- Name: frontend/real-purchase-flow.spec.ts >> 🛒 Fluxo de Compra Real (sem mock) >> TS02 — Busca de produto real + compra com cartão de crédito
- Location: e2e/specs/frontend/real-purchase-flow.spec.ts:257:3
