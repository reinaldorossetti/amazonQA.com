...
const REPORTS = [
  ...
  { title: 'Integração - REST Assured (Allure)', type: 'Integração/Contrato', description: 'Relatório Allure da suíte Java REST Assured (CI rest-assured-api-pipeline).', href: `${reportsBaseUrl}rest-assured-allure-report/index.html` },
  { title: 'Integração - REST Assured (JUnit)',  type: 'Integração/Contrato', description: 'JUnit XML Surefire publicado pela esteira REST Assured API.',                href: `${reportsBaseUrl}api-rest-assured/index.html` },
